...
import { ReviewPostSchema, ReviewUpvoteSchema, ReviewDeleteSchema } from "../schemas/Review.schema";
import { HTTPError } from "../../utils/Errors";
import { badRequest } from "../../utils/Constants";
import { IReviewUpvoteRequestBody, IReviewDeleteRequestBody } from "IApiResponses";
  ...
  setupRoutes(): Router {
    ...
    .put(
      ...
      async (req: Request, res: Response, next: NextFunction) => {
        ...
        try {
          const result = await this.reviewService.upvoteReview(
            reviewDetails
          );
          console.log("check5\n");
          return res.status(200).json(result);
